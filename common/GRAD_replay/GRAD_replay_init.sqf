...
GRAD_startRecording = compile preprocessFile "common\GRAD_replay\recording\recording.sqf";
GRAD_startPlayback = compile preprocessFile "common\GRAD_replay\playback\playback.sqf";
